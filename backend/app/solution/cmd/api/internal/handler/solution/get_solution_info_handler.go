...
func GetSolutionInfoHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetSolutionInfoReq
		...
		l := solution.NewGetSolutionInfoLogic(r.Context(), svcCtx)
		resp, err := l.GetSolutionInfo(&req)
